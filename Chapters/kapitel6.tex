...
\end{center}
\begin{eqnarr}
    \L \left( f(t) \right) &=& \int_0^\infty \cos(\alpha t)e^{-st}dt \\
...
\begin{eqnarr}
    \L \left[ f(t-a) \right] 
    &=&  \int_0^\infty f(t-a)e^{-st}\text{d}t\\
...
\begin{equation*}
    \boxed{
        \L\left[ t\cdot f(t) \right] = -\frac{\text{d}}{\text{d}s}F(s),
...
\begin{eqnarr}
    \L\left[ t\cdot f(t) \right] &=& 
        \int_0^\infty tf(t) e^{-st}\text{d}t\\
        &=& \int_0^\infty f(t) \left(   -\frac{\text{d}}{\text{d}s}e^{-st}
        \right)\text{d}t\\
        &=& -\frac{\text{d}}{\text{d}s}\int_0^\infty f(t)  e^{-st} \text{d}t\\
        &=& -\frac{\text{d}}{\text{d}s}F(s)\\
\end{eqnarr}
...
\begin{eqnarr}
    \L\left[ e^{-at}f(t) \right] &=& 
        \int_0^\infty e^{-at} f(t) e^{-st}\text{d}t\\
...
$\Rightarrow$
\begin{eqnarr}
    \L\left[ t^2 \right] &=& \L\left[ \int_0^t 2u\text{d}u \right]\\
